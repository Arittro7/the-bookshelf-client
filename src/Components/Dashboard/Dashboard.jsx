...
const Dashboard = () => {
  ...
  {/* Total Books */}
  <div className="flex items-center p-6 sm:p-8 bg-white shadow rounded-lg">
    <div className="inline-flex items-center justify-center h-14 w-14 sm:h-16 sm:w-16 text-purple-600 bg-purple-100 rounded-full mr-4 sm:mr-6">
      <svg
        aria-hidden="true"
        fill="none"
        viewBox="0 0 24 24"
    ...
    <div>
      <span className="block text-xl sm:text-2xl font-bold">{data?.totalBooks}</span>
      <span className="block text-gray-500 text-sm sm:text-base">Products</span>
    </div>
  </div>

  {/* Total Sales */}
  <div className="flex items-center p-6 sm:p-8 bg-white shadow rounded-lg">
    <div className="inline-flex items-center justify-center h-14 w-14 sm:h-16 sm:w-16 text-green-600 bg-green-100 rounded-full mr-4 sm:mr-6">
      <svg
        aria-hidden="true"
        fill="none"
        viewBox="0 0 24 24"
    ...
    <div>
      <span className="block text-xl sm:text-2xl font-bold">${data?.totalSales}</span>
      <span className="block text-gray-500 text-sm sm:text-base">Total Sales</span>
    </div>
  </div>

  {/* Trending Books */}
  <div className="flex items-center p-6 sm:p-8 bg-white shadow rounded-lg">
    <div className="inline-flex items-center justify-center h-14 w-14 sm:h-16 sm:w-16 text-red-600 bg-red-100 rounded-full mr-4 sm:mr-6">
      <svg
        aria-hidden="true"
        fill="none"
        viewBox="0 0 24 24"
    ...
    <div>
      <span className="text-xl sm:text-2xl font-bold">{data?.trendingBooks}</span>
      <span className="text-sm sm:text-base text-gray-500 font-semibold ml-1">(13%)</span>
      <p className="text-gray-500 text-sm sm:text-base">Trending Books This Month</p>
    </div>
  </div>

  {/* Total Orders */}
  <div className="flex items-center p-6 sm:p-8 bg-white shadow rounded-lg">
    <div className="inline-flex items-center justify-center h-14 w-14 sm:h-16 sm:w-16 text-blue-600 bg-blue-100 rounded-full mr-4 sm:mr-6">
      <MdIncompleteCircle className="h-6 w-6" />
    </div>
    <div>
      <span className="block text-xl sm:text-2xl font-bold">{data?.totalOrders}</span>
      <span className="block text-gray-500 text-sm sm:text-base">Total Orders</span>
    </div>
  </div>
</section>
