      ...
      <div className='lg:w-1/2 md:w-full max-w-sm mx-auto shadow-md rounded px-8 pt-6 pb-8 mb-4'>
        ...
        <form action="">
          <div className="mb-4">
            ...
            <input type="email" name="email" id="email" placeholder="email" className="shadow appearance-none border rounded w-full py-2 px-3 leading-tight focus:outline-none " />
          </div>
          <div className="mb-4">
            <label className="block text-gray-700 text-sm uppercase font-bold mb-2" htmlFor="email">Password</label>
            <input type="password" name="password" id="password" placeholder="password" className="shadow appearance-none border rounded w-full py-2 px-3 leading-tight focus:outline-none " />
          </div>
          {
            message && 
            <p className="text-sm text-red-400">Please entre valid email and password</p>
          }
          <div>
        ...
        <div className="mt-3">
          <button className="flex bg-black w-full text-white justify-center items-center gap-2 py-1.5 rounded-md hover:bg-yellow-400 hover:text-black">
          <FaGoogle/>
